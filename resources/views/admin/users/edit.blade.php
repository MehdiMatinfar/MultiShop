                                        ...
                                        <div class="row align-items-center h-100">
                                            <div class="col-md-4">
                                                <figure class="avatar mx-auto mb-4 mb-md-0">
                                                    <img src="{{asset('images/faces/face20.jpg')}}" alt="avatar">
                                                </figure>
                                            </div>
                                            <div class="col-md-8">
                            ...
                            <form method="post" action="{{ url('admin/users/update') }}">
                                ...
                                <div class="table-responsive pt-3">
                                    ...
                                    <div class="col-md-9 form-group">
                                        ...
                                        <input type="text" class="form-control" id="usr" value="{{$user->name}}" name="name">
                                    </div>

                                    <div class="col-md-9 form-group">
                                        <label for="eml">Email</label>
                                        <input type="text" value="{{$user->email}}" class="form-control" id="eml" name="email">
                                    </div>
                                    <div class="col-md-9 form-group">
                                    ...
                                    <div style="margin-left: 10px;" class="col-md-9 custom-file form-group">
                                        <input type="file" class="custom-file-input"  id="file" name="photo_id"  enctype="multipart/form-data">
                                    ...
                                    @if(count($errors)>0)
                                        ...
                                        <div class="alert alert-danger col-md-9 form-group ">
...
<script>
    import Buttons from "../../ui-features/buttons.html";
    export default {
        components: {Buttons}
    }
</script>
