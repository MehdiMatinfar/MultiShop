        ...
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
            ...
            <ul class="navbar-nav navbar-nav-right">
                <li class="nav-item nav-search d-none d-md-block mr-0">
                    ...
                    <form  method="post" action="{{ route('search_user') }}" id="theForm">
                ...
                <span class="input-group-text" id="search">
                  <i onClick="placeOrder()"  class="typcn typcn-zoom"></i>
                </span>
                            </div>
                        </div>
...
@foreach($users as $user)
    <tr>
        ...
        <td> {{$user->name}}</td>
        <td>{{$user->email}}</td>
        <td><img src="/images/{{$user->photo_id ? $user->photo_id:'no user photo'}} " style="height: 50px;"/></td>
        ...
        <td>
            <div class="d-flex align-items-center">
                <button type="button" class="btn btn-success btn-sm btn-icon-text mr-3">
                    Edit
                 <a href="{{url('admin/users/edit/').'/'.$user->id}}"> <i class="typcn typcn-edit btn-icon-append"></i> </a>
                </button>
                <button type="button" class="btn btn-danger btn-sm btn-icon-text">
                    Delete
                    <a href="{{url('admin/users/delete/').'/'.$user->id}}"> <i class="typcn typcn-delete-outline btn-icon-append"></i></a>
                </button>
            </div>
        </td>
    </tr>
